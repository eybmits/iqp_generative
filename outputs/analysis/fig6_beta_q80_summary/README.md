...
- per-seed metrics: `outputs/analysis/fig6_multiseed_all600_seeds42_46/fig6_beta_sweep_recovery_grid_multiseed_metrics.csv`
- multiseed recovery curves: `outputs/analysis/fig6_multiseed_all600_seeds42_46/fig6_beta_sweep_recovery_grid_multiseed_data.npz`
...
- the summary curve shows the seed-median only to keep the figure compact
- the companion metrics CSV still contains `q25/q50/q75` for the same runs
