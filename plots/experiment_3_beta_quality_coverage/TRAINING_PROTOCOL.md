...
- experiment: `Experiment 3 beta quality coverage summary`
...
- experiment-specific metric note: The plotted curves show seedwise mean quality coverage with interquartile bands; medians and 95% CIs are stored alongside the rerender artifacts.
