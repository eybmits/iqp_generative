...
- experiment: `Experiment 13 IBM hardware global-best IQP coverage`
...
- note: Load Experiment 12 global-best parity weights and IQP-MSE weights, sample the final circuits on IBM hardware, and evaluate the same elite-unseen quality-coverage metric used in Experiment 3.

- source driver: `experiment_13_ibm_hardware_global_best_coverage.py`
